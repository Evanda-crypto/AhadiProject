        ...
        <div class="content">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                           <center> <strong class="card-title">Signed [R&M]</strong></center>
                        </div>
                        <div class="card-body">
                        <?php
            ...
            ?>
                     ...
                     <th>More</th>
                        ...
                        LEFT JOIN papnotinstalled AS r ON r.ClientID=p.ClientID WHERE r.ClientID is null and p.Region='R&M' order by p.ClientID Desc";

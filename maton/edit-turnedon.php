...
$change="update papinstalled set ClientID=$id,MacAddress='$MAC' where ClientID=$id";

$res=mysqli_query($connection,$change);
if ($result && $updt && $change) {
            ...
            <div class="animated fadeIn">
              ...
              <div class="card-header">
                        ...
                        <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-earning" id="example">
                                        <thead>
                                            <tr>
                   ...
                   <th class="th-sm">MAC Address
                                        ...
                                        <?php
$sql =
    "SELECT turnedonpap.ClientID,papdailysales.BuildingName,upper(papdailysales.BuildingCode) as bcode,upper(papdailysales.Region) as reg,papdailysales.ChampName,turnedonpap.ClientName,papdailysales.ClientContact,Upper(turnedonpap.MacAddress) as Mac,turnedonpap.PapStatus,turnedonpap.DateTurnedOn from papdailysales LEFT JOIN turnedonpap ON turnedonpap.ClientID=papdailysales.ClientID WHERE DateTurnedOn=CURDATE()";

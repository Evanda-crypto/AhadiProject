...
<body style="background-color:#e1e1e1">
  ...
  <aside id="left-panel" class="left-panel">
    ...
    end as papcode from papdailysales LEFT JOIN turnedonpap ON turnedonpap.ClientID=papdailysales.ClientID where turnedonpap.ClientID is not null and DATE_SUB(CURDATE(), INTERVAL 7 DAY)";

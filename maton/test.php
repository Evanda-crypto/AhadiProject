...
<body style="background-color:#e1e1e1">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div align="right"><div class="modal-footer">  <p align="right"> <input class="btn btn-success" type="submit" name="turnon" onClick="return confirm('Sure to change teh status of the selected records to Turned On?')"  value="Turn On Multiple"></p></div></div>

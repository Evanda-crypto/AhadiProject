...
<body style="background-color:#e1e1e1">
   ...
   <aside id="left-panel" class="left-panel">
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-lg-12">
                        <div class="card">
                            ...
                            <center><strong class="card-title">G44 [<?php
         $query="SELECT COUNT(*) as buildings FROM buildings WHERE region='G44'";
    ...
    $sql="SELECT bname,bcode,region,mtrno,champs_sales,iap,oap,shops,apt,id,bstatus from buildings where region='G44'";

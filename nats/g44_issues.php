...
<body style="background-color:#e1e1e1">
    ...
    $sql="SELECT dayname(date_reported) as dayn,date_reported,CONCAT('1. ',issue1,'".'<br>'."','2. ',issue2,'".'<br>'."','3. ',issue3,'".'<br>'."','4. ',issue4) as issues,reporter,comments from nats_reports where Region='G44'";

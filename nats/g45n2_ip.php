...
?>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                           <center> <strong class="card-title">IP Reports G45N 2</strong></center>
                        </div>
    ...
    from ip_document_reports where region='G45N 2' group by zones,cluster";

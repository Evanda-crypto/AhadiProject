...
<body style="background-color:#e1e1e1">
 ...
 <aside id="left-panel" class="left-panel">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                           <center> <strong class="card-title">IP Reports G45S</strong></center>
                        </div>
    ...
    from ip_document_reports where region='G45S' group by zones,cluster";

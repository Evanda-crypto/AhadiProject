...
if(isset($_POST["submit"])){
    ...
    $buildings = trim($_POST['buildings']);
    $building_codes = trim($_POST['building_codes']);
    $iap = trim($_POST['iap']);
    $pap = trim($_POST['pap']);
    $oap = trim($_POST['oap']);
    ...
    $p5p_2005 = trim($_POST['5p_2005']);
                        ...
                        $insert = $connection->query("INSERT INTO ip_document_reports (zones,vlanid_device,vlanid_user,device_ip,user_ip,cluster,buildings,building_codes,status,iap,

...
<body style="background-color:#e1e1e1">
   ...
   <aside id="left-panel" class="left-panel">
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-lg-12">
                        <div class="card">
                            ...
                            <center><strong class="card-title">KWT [<?php
         $query="SELECT COUNT(*) as buildings FROM buildings WHERE region='KWT'";
    ...
    $sql="SELECT bname,bcode,region,mtrno,champs_sales,iap,oap,shops,apt,id,bstatus from buildings where region='KWT'";
    ...
    while($row=$result->fetch_array()){
      ...
      <tr>
        ...
        <td>
       <button class="btn btn-warning"><a href="updates/kwt.php?id=<?php echo $row['id']; ?>">Edit</i></a></button>
    </td>
    </tr>
    <?php } ?>
                                </tbody>

...
<body style="background-color:#e1e1e1">
 ...
 <aside id="left-panel" class="left-panel">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                           <center> <strong class="card-title">IP Reports KWT 2</strong></center>
                        </div>
    ...
    from ip_document_reports where region='KWT 2' group by zones,cluster";

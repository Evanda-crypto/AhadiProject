...
if (isset($_POST["submit"])) {
    ...
    $sql =
        ...
        FROM nats_reports where date_reported BETWEEN '" .
        $start .
        "' AND '" .
        $end .
        "' and Region='".$Region."'
...
<!--start-->
    ...
    $sql="SELECT region,issue,COUNT(*) as numba from nats_reports GROUP BY region,issue";
    ...
    datasets: [
        {
            ...
            borderWidth: "0",
            backgroundColor: [  '#E666B3', '#33991A', '#CC9999', '#B3B31A', '#00E680', 

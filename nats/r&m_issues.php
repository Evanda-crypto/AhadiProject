...
<body style="background-color:#e1e1e1">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <li><i class="fa fa-inbox"></i><a href="zmm_issues.php" style="color:black; font-size: 15px;">ZMM</a></li>
                            ...
                            <li><i class="fa fa-inbox"></i><a href="g44.php" style="color:black; font-size: 15px;">G44</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                           <center> <strong class="card-title">R&M Reports</strong></center>
                        </div>
    ...
    $sql="SELECT dayname(date_reported) as dayn,date_reported,CONCAT('1. ',issue1,'".'<br>'."','2. ',issue2,'".'<br>'."','3. ',issue3,'".'<br>'."','4. ',issue4) as issues,reporter,comments from nats_reports where Region='R&M'";

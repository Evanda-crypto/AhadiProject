...
else
{
  ...
  if ($result) {
    echo '<script>alert("Update Successfull!")</script>';
      echo '<script>window.location.href="../g44.php";</script>';
  } else {
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-6">
                                            ...
                                            <strong> <label for="cc-payment" class="control-label mb-1">Date Signed</label></strong>
                                                <input id="date" name="datesigned"  type="text" value="<?php echo $datesigned?>"  class="form-control"  aria-required="true" aria-invalid="false" placeholder="Date Signed">
                                            </div></div>
                                            <div class="col-6">
                                            <div class="form-group has-success">

    ...
    <!-- /#left-panel -->
     ...
     <div id="right-panel" class="right-panel">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                           <center> <strong class="card-title">All records</strong></center></div>
      ...
      <th class="th-sm">Date Installed
                                ...
                                <tbody>
                                <?php
                                $query = "SELECT i.ClientID,p.Region,p.BuildingName,p.BuildingCode,upper(i.MacAddress) as mac,t.Techie1,t.Techie2,t.Techie3,FLOOR(300/i.split) as amount,p.ClientName,p.ClientContact,p.ChampName,
                        p.Region,i.DateInstalled FROM papdailysales as p left join papinstalled as i ON i.ClientID=p.ClientID left join Token_teams as t on t.Team_ID=i.Team_ID where i.MacAddress is not null";

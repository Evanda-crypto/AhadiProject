...
<body style="background-color:#e1e1e1">
 ...
 <?php
 $query =
     "SELECT p.ClientID,p.ClientName,p.BuildingName,p.BuildingCode,p.Floor,p.DateSigned,p.Reason,p.Contact,p.ChampName,p.RestitutedDate from papnotinstalled as p  where  p.Reason<>'Already Installed' order by DateSigned Desc";

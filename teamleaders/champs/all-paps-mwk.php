        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="retrieved_paps.php" style="color:black; font-size: 15px;"> <i class="menu-icon ti-layout-grid3"></i>Assigned</a>
                    </li>
                    <li>
            ...
            ?>
                    ...
                    <th>Pap Status</th>
                     <th>Edit</th>
                        ...
                        where p.PapStatus<>'Restituted' and p.Region='MWK'";

...
if (is_array($data) || is_object($data))
{
    foreach($data as $row)
    {
        ...
        <tr>
            ...
            <td><?php echo $row['completed']; ?></td>
            <td>
            <button class="btn btn-warning"  onClick="return confirm('Confirm Resubmitting Meter Number <?php echo $row['completed']; ?> from <?php echo $row['completed']; ?> as New Meters')"><a href="changemtrstatus.php?id=<?php echo $row['id']; ?>">Resubmit</a></button>
            </td>
